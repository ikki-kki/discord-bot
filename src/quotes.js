const QUOTES = [
  ...
  { text: "Do it now. Sometimes 'later' becomes 'never'.", author: "Mark Twain" },
  ...
  { text: "오늘 씨를 뿌리지 않으면 내일 거둘 것이 없다.", author: "브라이언 트레이시" },
  ...
  { text: "포기하지 마라. 지금이 가장 힘들 때일 수 있다.", author: "로버트 H. 슐러" },
  ...
  { text: "어려움은 끝이 있다. 포기는 없다.", author: "마틴 루터 킹" },
